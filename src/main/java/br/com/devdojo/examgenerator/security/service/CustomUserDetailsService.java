...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        return new CustomUsersDetails(applicationUser);
    }
    ...
    private final static class CustomUsersDetails extends ApplicationUser implements UserDetails{

        private CustomUsersDetails(ApplicationUser applicationUser){
